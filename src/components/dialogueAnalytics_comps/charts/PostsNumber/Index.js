    ...
    return (
        <div className='single-chart'>
            <div className="chart-info">
                <h4>Количество сообщений в вопросах</h4>
                <div className="chart-global-stats">
                    <div className="stat lg-col-50">
                        <span>0</span>
                        <p>Средняя длина вопроса</p>
                    </div>
                    
                </div>
            </div>

            <p className="chart-title">Длина вопроса в сообщениях по часам</p>
