    ...
    return (
        <div className='single-chart'>
            <div className="chart-info">
                <h4>Загруженность по часам</h4>
                <div className="chart-global-stats">
                    <div className="stat lg-col-100">
                        <span>29 ноября, 12:00 — 15:00</span>
                        <p>Самое загруженно время</p>
                    </div>
                </div>
            </div>

            <p className="chart-title">Загруженность по количеству вопросов  </p>
